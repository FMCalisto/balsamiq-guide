...
%%
% Book metadata
\title{Guia Balsamiq\thanks{Professor Joaquim Jorge}}
\author[The Tufte-LaTeX Developers]{Usabilidade e Sistemas de Informação}
\publisher{Francisco Maria Calisto}
...
\begin{center}
	\includegraphics[width=16.50cm]{media/img1.png}
\end{center}
